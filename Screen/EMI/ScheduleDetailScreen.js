...
//                     const currentMonthItem = parsedSchedule.find(item => item.month === scheduleItem.month);
...
//             {/* <Text>No of EMI Payment: {numberOfPaidEMIs } </Text> */}
//             <Text>No of EMI Payment: {scheduleItem.month } </Text>
//                 <TouchableOpacity
//                     style={[styles.button, { backgroundColor: isPaid ? 'green' : 'red' }]}
//                     // onPress={() => handlePaidButtonPress(loanDetails)}
//                     disabled={isPaid}
//                 >
//                     <Text style={styles.buttonText}>{isPaid ? 'Paid' : 'Mark as Paid'}</Text>
//                 </TouchableOpacity>
//                 {/* {new Date() > new Date(scheduleItem.paymentDate) && !scheduleItem.paid && (
//                     <View style={{ marginTop: 20 }}>
//                         <Text style={{ fontWeight: 'bold', marginBottom: 5 }}>Other Charge:</Text>
//                         <Text>{calculateOtherCharge()}</Text>
//                     </View>
//                 )} */}
//                 <TextInput
//                     style={styles.input}
...
//                 <Text>New EMI Payment: {calculateNewEMIPayment()}</Text>

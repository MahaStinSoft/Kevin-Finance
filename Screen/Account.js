...
//         <View style={{ width: '100%', flexDirection: 'row', backgroundColor: 'white',borderRadius:10, marginTop: 0, paddingLeft:  20, height: '14%' }}>
//           <Image
//             source={{ uri: `data:image/png;base64,${user.kf_profilepicture}` }}
//             style={styles.cardImage}
//             onError={(error) => console.error('Image load error:', error.nativeEvent.error)}
//           />
//           <View style={{ width: '50%', paddingTop: 20, paddingLeft: 10 }}>
//             <Text style={{ color: 'red', fontWeight: 'bold', fontSize: 18, letterSpacing: 1, paddingBottom: 8 }}>{user.kf_adminname}</Text>
//             <Text style={{ color: 'red', letterSpacing: 1,fontWeight: 'bold', marginLeft:1 }}>{user.kf_employeeid}</Text>
//           </View>
//         </View>
//       )}
      ...
      {user && user.kf_profilepicture && (
        <View style={styles.profileContainer}>
          ...
          <View style={styles.profileInfo}>
            <Text style={styles.profileText}>{user.kf_adminname}</Text>
            <Text style={styles.profileText}>{user.kf_employeeid}</Text>
          </View>
        </View>
      )}
      <ScrollView showsVerticalScrollIndicator={false} showsHorizontalScrollIndicator={false}>

...
const PersonalSignatureScreen  = ({ route }) => {
  ...
  // console.log('base64',base64Data);
      ...
      navigation.navigate('EditPersonalLoan', { signatureFile: base64Data, personalLoan: personalLoan });
    } catch (error) {
...
export default PersonalSignatureScreen ;

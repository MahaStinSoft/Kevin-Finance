...
const Gurantee2Annotation = ({ annotations, filteredAnnotations, showImage, handleViewImages }) => {
    ...
    const latestHG2AadharAnnotation = getLatestAnnotation('Guarantee2 AadharCard Image');
    const latestHG2PanAnnotation = getLatestAnnotation('Guarantee2 PanCard Image');
    const latestHG2AppicantAnnotation = getLatestAnnotation('Guarantee2 Applicant Image');
    const latestHG2SignatureAnnotation = getLatestAnnotation('Gurantee2 Signature Image');  
...
export default Gurantee2Annotation;

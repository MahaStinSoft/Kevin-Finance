...
// // Added KeyboardAvoidingView, ImageBackground
...
//         "https://org0f7e6203.crm5.dynamics.com/api/data/v9.0/kf_loanapplications()?$select=kf_password,kf_name",
//         {
//           headers: {
      ...
      if (response.status === 200) {
        ...
        if (matchedUser) {
          ...
          if (matchedUser.accountrolecode === 3) {
            ...
            console.log("Authenticated user:", matchedUser);
            console.log("response.data", response.data);
            navigation.navigate("AdminDashboardScreen", { authenticatedUser: matchedUser });
          } else {
        ...
        <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
          <View style={styles.backgroundContainer}>
            <View style={styles.modalText}>
              ...
              <Text style={{textAlign: "center", marginBottom: 10, fontSize: 18, fontWeight: "bold",color: "red"}}>MANAGER LOGIN</Text>
